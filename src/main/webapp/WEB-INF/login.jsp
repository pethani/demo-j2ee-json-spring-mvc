							...
							<div class="col3_box_contentpage">
								<div class="content" align="center">
									...
									<form method="post" action="home.html">
										<div align="center">
											<div align="left" style="height: 335px; width: 500px;">
												<b>User name:</b> <input type="text" placeholder="Username"
													name="txtuname" style="width: 230px" required="required">&nbsp;&nbsp;
												<c:if test="${ userfalse == true}">
													<font color="red">User name is incorrect</font>
												</c:if>
												<br> <br> <b>Password:</b> &nbsp;<input
													type="password" placeholder="Password" name="txtpass"
													style="width: 230px;" required="required">&nbsp;&nbsp;
												<c:if test="${passfalse == true}">
